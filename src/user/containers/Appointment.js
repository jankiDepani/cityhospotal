...
import { Input } from '../component/UI/InputBox/input.style';
                    ...
                    <form action method="post" role="form" className="php-email-form">
                        ...
                        <div className="row">
                            <div className="col-md-4 form-group mt-3">
                                <Input type="datetime" name="date"  id="date" placeholder="Appointment Date" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                <div className="validate" />
                            </div>
                            <div className="col-md-4 form-group mt-3">
